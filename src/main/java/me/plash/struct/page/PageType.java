...
public class PageType {
     ...
     */
    public static final Short PAGE_TYPE_ALLOCATED = 0;
    public static final Short PAGE_UNDO_LOG = 2;
    public static final Short PAGE_INODE = 3;
    public static final Short PAGE_IBUF_FREE_LIST = 4;
    public static final Short PAGE_IBUF_BITMAP = 5;
    public static final Short PAGE_TYPE_SYS = 6;
    public static final Short PAGE_TYPE_TRX_SYS = 7;
    public static final Short PAGE_TYPE_FSP_HDR = 8;
    public static final Short PAGE_TYPE_XDES = 9;
    public static final Short PAGE_TYPE_BLOB = 10;
    public static final Short PAGE_INDEX = 0x45BF;
